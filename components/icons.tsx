...
export const FingerprintIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11c0 3.517-1.009 6.789-2.75 9.566-1.74 2.777-2.57 5.022-2.57 6.434 0 1.414 1.14 2.553 2.553 2.553h.003c1.414 0 2.553-1.14 2.553-2.553 0-1.412-.83-3.657-2.57-6.434-1.74-2.777-2.75-6.049-2.75-9.566z M12 11c0-1.104.896-2 2-2s2 .896 2 2-.896 2-2 2-2-.896-2-2z"/>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.998 10.998C20.998 5.476 16.522 1 11 1S1 5.476 1 10.998"/>
    </svg>
);
...
export const TruckIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 17H6V6h10l4 4v7h-4M6 17H4m12 0h2" />
  </svg>
);
...
export const CameraIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-10 w-10 text-medium-gray ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-15l1.09 2.22L12 6l-1.91 1.22L9 9.44l-1.09-2.22L6 6l1.91-1.22L9 2.56zM15 15l1.09 2.22L18 18l-1.91 1.22L15 21.44l-1.09-2.22L12 18l1.91-1.22L15 15z" />
    </svg>
);
